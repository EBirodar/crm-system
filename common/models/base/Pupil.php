...
/**
 * This is the base-model class for table "_pupil".
 *
 * @property integer $id
 ...
 */
abstract class Pupil extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\PupilQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\query\PupilQuery(get_called_class());
    }
