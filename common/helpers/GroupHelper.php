...
class GroupHelper
{
    ...
    {
        return [
            Group::DURATION_1 => Yii::t('models', '1 oy'),
            Group::DURATION_2 => Yii::t('models', '2 oy'),
            Group::DURATION_3 => Yii::t('models', '3 oy'),
            Group::DURATION_4 => Yii::t('models', '4 oy'),
            Group::DURATION_5 => Yii::t('models', '5 oy'),
            Group::DURATION_6 => Yii::t('models', '6 oy'),
            Group::DURATION_7 => Yii::t('models', '7 oy'),
            Group::DURATION_8 => Yii::t('models', '8 oy'),
            Group::DURATION_9 => Yii::t('models', '9 oy'),
            Group::DURATION_10 => Yii::t('models', '10 oy'),
            Group::DURATION_11 => Yii::t('models', '11 oy'),
            Group::DURATION_12 => Yii::t('models', '12 oy'),
        ];
    }
    ...
    public static function getEquelDays()
    {
...
//    {
//        $dayList = GroupDays::find()
//            ->select('group_days.id, group_days.name')
//            ->active()
//            ->asArray()
//            ->all();
//
//        return ArrayHelper::map($dayList, 'id', function ($model) {
//            return $model['name'];
//        });
//    }

//    public static function getDayName(int $name)
//    {
//        return ArrayHelper::getValue(self::getDayList(), $name);
//    }
}
