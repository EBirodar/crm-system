 ...
 * @var common\models\search\GroupSearch $searchModel
 */
    ...
    <div>
        ...
        $gridColumns = [
            ...
            [
                ...
                'format' => 'raw',
                'filter' => GroupHelper::getActionList(),
            ...
            [
                ...
                'format' => 'raw',
                'filter' => GroupHelper::getTypeList(),
                'filterType' => GridView::FILTER_SELECT2,
                'filterWidgetOptions' => [
                    'options' => ['prompt' => 'Select...'],
                    'pluginOptions' => ['allowClear' => true],
            ...
            [
                ...
                'format' => 'raw',
                'filter' => GroupHelper::getStatusList(),
                'filterType' => GridView::FILTER_SELECT2,
                'filterWidgetOptions' => [
                    'options' => ['prompt' => 'Select...'],
                    'pluginOptions' => ['allowClear' => true],
