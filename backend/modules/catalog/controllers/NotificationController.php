...
use backend\modules\catalog\forms\NotificationCreateForm;
use backend\modules\catalog\forms\NotificationUpdateForm;
use Yii;

/**
* This is the class for controller "NotificationController".
*/
class NotificationController extends \backend\modules\catalog\controllers\base\NotificationController
{
    /**
