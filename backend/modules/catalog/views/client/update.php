 ...
 * @var common\models\Client $modelsClient
...
<div class=" client-create">
    ...
    <h1>
        <?= Yii::t('models', 'Client') ?>
        <small>
            <?= Html::encode($modelsClient->full_name) ?>
    ...
    <div class="client-form">
        ...
        <section>
            ...
            <?= $form->field($modelsClient, 'groupList')->widget(Select2::class, [
            ...
            <div>
                                ...
                                foreach ($modelsPhone as $i => $modelPhone): ?>
                                    <div class="item panel panel-default"><!-- widgetBody -->
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <?= $form->field($modelPhone, "[{$i}]phone")->textInput() ?>
                ...
                <?= $form->field($modelsClient, 'visited_date')->textInput(['type' => 'datetime']) ?>

                <!-- attribute commit -->
                <?= $form->field($modelsClient, 'comment')->textarea([
                    'rows' => 4
                ]) ?>
