...
<div class="notification-update">
    ...
    <div class="crud-navigation">
        <?= Html::a('<span class="glyphicon glyphicon-file"></span> ' . 'View', ['view', 'id' => $model->id], ['class' => 'btn btn-info']) ?>

        <div class="pull-right">
            <?= Html::a('<span class="glyphicon glyphicon-list"></span> ' . 'Full list', ['index'], ['class' => 'btn btn-warning']) ?>
        </div>
    </div>
    ...
    <div class="notification-form">
        ...
        <section>
            <div>
                ...
                <?= $form->field($updateForm, 'description')->textarea(['rows' => 4]) ?>
                <?= $form->field($updateForm, 'group')->dropDownList(NotificationHelper::getGroupList(), ['prompt' => 'Выбирать ...']) ?>
